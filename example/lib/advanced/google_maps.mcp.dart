...
/// Generated extension for [GoogleMapsMCP] that provides automatic registration
...
extension GoogleMapsMCPRegistration on GoogleMapsMCP {
  ...
  void registerGeneratedHandlers() {
    ...
    registerTool(
      ...
      (context) async {
        ...
        final type = context.optionalParam<String?>('type');
