...
class TemplateEngine {
  ...
  static const String baseClassTemplate =
...
{{parameterExtractions}}
  ...
  /// all annotated top-level functions from the source file.
  static const String topLevelRegistrationTemplate =
      '''/// Generated registration function for top-level MCP handlers.
///
/// Call this function passing your [MCPServer] instance to register all
/// annotated tools, resources, and prompts defined as top-level functions
/// in `{{sourceFile}}`.
///
/// This code is automatically generated by the MCP Dart framework.
/// Do not modify this file directly - instead, modify the source
/// file and run `dart run build_runner build` to regenerate.
void {{registrationFunctionName}}(MCPServer server) {
{{handlerRegistrations}}
}''';
}
