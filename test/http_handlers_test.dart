...
void main() {
  group('HttpHandlers Streamable HTTP', () {
    test(
      'initialize creates a server session even when client provides session id',
      () async {
    ...
    test(
      'SSE session stores forwarded headers and reuses them for later responses',
      () async {
